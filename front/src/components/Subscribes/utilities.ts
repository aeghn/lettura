...
function flatten(items: FeedResItem[], parentId: string | null = null, depth = 0): FeedResItem[] {
...
export function findItemDeep(items: TreeItem[], itemId: string): TreeItem | undefined {
...
export function findFolderAndIndex(items: FeedResItem[], uuid: string): [number, FeedResItem] {
...
export function adjustedTargetIndex(targetIndex: number, foundIndex: number, position: string | null) {
  if (position !== "top") {
    targetIndex += 1;
  }

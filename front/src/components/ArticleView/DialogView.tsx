...
export const ArticleDialogView = (props: ArticleDialogViewProps): JSX.Element => {
  const { article, dialogStatus, setDialogStatus, afterConfirm, afterCancel, trigger } = props;
        ...
        <ScrollBox className="h-[94vh]" ref={scrollBoxRef}>
          <>
            <div className="sticky left-0 right-0 top-0 z-[3]">
              <div className="flex items-center justify-end px-20 py-2 space-x-0.5 rounded-tl-lg rounded-tr-lg bg-background border-b">
                <ToolbarItemNavigator goNext={function (): void {}} goPrev={function (): void {}} />
                <span>
            ...
            <div className="relative px-20 py-10">{article ? <ArticleDetail article={article} /> : ""}</div>
            {/* </div> */}
          </>
        </ScrollBox>
      </DialogContent>
